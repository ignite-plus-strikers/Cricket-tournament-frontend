...
const Tournament = [
  ...
  {
    value: "First T-20 World Cup",
    label: "First T-20 World Cup",
  },
];
const SeriesType = [
  {
...
class SeriesComponent extends Component {
  ...
  componentDidMount() {
    ...
    ValidatorForm.addValidationRule("isValidStartDate", (value) => {
      if (value >= todayDate) {
        return true;
      }
      return false;
    ...
    ValidatorForm.addValidationRule("isValidEndDate", (value) => {
      if (value > this.state.series_start_date) {
        return true;
      }
      return false;
    });

    ValidatorForm.addValidationRule("isValidPoints", (value) => {
      if (value >= 0) {
        return true;
      }
      return false;
  ...
  componentWillUnmount() {
    ...
    ValidatorForm.removeValidationRule("isValidStartDate");
    ValidatorForm.removeValidationRule("isValidEndDate");
    ValidatorForm.removeValidationRule("isValidPoints");
  }

  refreshSeries() {
    SeriesDataService.retrieveAllSeries().then((response) => {
  ...
  deleteSeriesClicked(id, series_short_name) {
    SeriesDataService.deleteSeries(id).then((response) => {
      this.setState({
        message: `Delete of series ${series_short_name} is Successful`,
      });
      this.refreshSeries();
    });
  }
  ...
  openUpdateForm = (e) => {
    ...
    SeriesDataService.retrieveSeries(e).then((response) =>
      this.setState({
  ...
  handleSubmit = () => {
    ...
    console.log(series);
    SeriesDataService.createSeries(series).then((response) => {
  ...
  handleUpdate = () => {
    ...
    SeriesDataService.updateSeries(this.state.series_id, series).then(
      (response) => {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        headerClassName: "header-class",
        accessor: (value) => {
          return value.points_table_active ? "Yes" : "No";
        },
        filterMethod: (filter, row) => {
          var v = row[filter.id]
            .toString()
        ...
        Cell: (props) => {
          return (
            <Button
              ...
              onClick={() => this.addTeamClicked(props.original.series_id)}
            >
              Add
            </Button>
          );
        ...
        Cell: (props) => {
          return (
            <Button
              ...
              onClick={() => this.showTeamClicked(props.original.series_id)}
            >
              Show
            </Button>
          );
        ...
        Cell: (props) => {
          return (
            <Button
              ...
              color="secondary"
              onClick={() =>
                this.deleteSeriesClicked(
                  props.original.series_id,
                  props.original.series_short_name
                )
              }
            >
              Delete
        ...
        Cell: (props) => {
          return (
            <Button
              ...
              onClick={() => this.openUpdateForm(props.original.series_id)}
            >
              Update
            </Button>
          );
            ...
            >
              ...
              <ValidatorForm onSubmit={this.handleSubmit} autoComplete="off">
                ...
                <TextValidator
                  ...
                  validators={["required", "isValidStartDate"]}
                  errorMessages={[
                    "This field is required!",
                    "Series must start today or in the future!",
                  ]}
                ...
                <TextValidator
                  ...
                  validators={["required", "isValidEndDate"]}
                  errorMessages={[
                    "This field is required!",
                    "Series must end after start date!",
                  ]}
                ...
                <TextValidator
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">Host 1</InputAdornment>
                    ),
                  }}
                  validators={["required"]}
                  errorMessages={["This field is required!"]}
                ...
                <TextValidator
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">Host 2</InputAdornment>
                    ),
                  }}
                />
                <TextValidator
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">Host 3</InputAdornment>
                    ),
                  }}
                />
                <TextValidator
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">Host 4</InputAdornment>
                    ),
                  }}
                />
                <TextValidator
                  ...
                  validators={["required", "isValidPoints"]}
                  errorMessages={["This field is required!", "Points must be a valid whole number!"]}
          ...
          <DialogContent>
            ...
            >
              ...
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">Short Name</InputAdornment>
                  ),
                }}
              />
              <br />
