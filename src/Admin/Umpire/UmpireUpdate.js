...
class UmpireUpdate extends Component {
    constructor(props) {
        super(props)

        this.state = {
            umpire_id: this.props.match.params.id,
            first_name:'',
            middle_name:'',
            last_name:'',
            city:'',
    ...
    componentDidMount() {
        UmpireDataService.retrieveUmpire(this.state.umpire_id)
