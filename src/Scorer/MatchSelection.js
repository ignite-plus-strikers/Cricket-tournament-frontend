      ...
      <div style={{ marginTop: 100 }}>
        ...
        <Container>
          <Typography
            ...
            style={{ marginTop: 0 }}
          >
            Welcome {user_name}! Happy Scoring!{" "}
          </Typography>
          {this.state.fixtures.map((fixture) => {
            if (
              moment(todayDate).isSame(fixture.fixture_date) &&
              time > fixture.fixture_start_time &&
              time < fixture.fixture_end_time
            ) {
              return (
                <div>
                  <Typography
                  ...
                  >
                    <CardContent style={{ padding: 5 }}>
                      ...
                      <Typography
                        ...
                        color="textSecondary"
                      >
                        <b>{fixture.description}</b> at <b>{fixture.venue}</b>{" "}
                        <br />
                        scheduled on{" "}
                        <b>
                          {fixture.fixture_date} {fixture.fixture_start_time}
                        </b>{" "}
                      </Typography>
                    </CardContent>
                    <Divider />
                    <CardActions>
                      <Button
                        ...
                        style={{ margin: "auto" }}
                        onClick={() =>
                          this.PrematchScreenClicked(fixture.fixture_id)
                        }
                      >
                        Pre-match Screen
                      </Button>
          ...
          {this.state.fixtures.map((fixture) => {
            if (moment(todayDate).isSameOrBefore(fixture.fixture_date)) {
              if (flag === 0) {
                flag = 1;
                return (
                  <Typography
                  ...
                  >
                    <CardContent style={{ padding: 5 }}>
                      <Typography variant="h5" color="primary" align="center">
                        {fixture.team1} <br /> VS <br /> {fixture.team2}
                      </Typography>
                      <Divider />
                      <Typography
                        variant="body1"
          ...
          {this.state.fixtures.map((fixture) => {
            if (moment(todayDate).isBefore(fixture.fixture_date)) {
              return (
                <div className={classes.node}>
                  <Card
                    className={classes.root}
